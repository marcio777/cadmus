In coding we often want a way to control which statements run and which don't based on a certain condition. If-else statements are a way to do just that.
